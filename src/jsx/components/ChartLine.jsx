...
function LineChart({
  allow_decimals = false, data, idx, line_width = 3, note = false, show_first_label = true, source, subtitle = false, suffix = '', title, title_margin = 40, xlabel, ymax = undefined, ymin = undefined, ytickinterval = 10
}) {
