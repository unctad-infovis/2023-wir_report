...
function App() {
  ...
  useEffect(() => {
    const data_file = (window.location.href.includes('unctad.org')) ? 'https://storage.unctad.org/2023-wir_report/assets/data/2023-wir_report_figure1.json' : './assets/data/2023-wir_report_figure1.json';
    try {
      fetch(data_file)
        .then((response) => {
          if (!response.ok) {
  ...
  const createChart = useCallback(() => {
    chart = Highcharts.chart('highchart-container', {
      ...
      xAxis: {
        accessibility: {
          description: 'Year from 1990 to 2022'
        },
        allowDecimals: false,
        crosshair: {
      ...
      <div className="layout">
        ...
        <div className="right_container">
          ...
          <div className="title_container">
            <h3>By region and economy, 1990–2022</h3>
